package com.koreacb.confluence.aigeneration.listener;
...
public class PluginLifecycleListener implements InitializingBean, DisposableBean {
    ...
    private static final String PLUGIN_KEY = "com.koreacb.confluence.ai-page-generation";

    // Job runner keys
    private static final JobRunnerKey GENERATION_JOB_KEY =
            JobRunnerKey.of("com.koreacb.confluence.ai-page-generation:generationJobRunner");
    private static final JobRunnerKey CLEANUP_JOB_KEY =
            JobRunnerKey.of("com.koreacb.confluence.ai-page-generation:cleanupJobRunner");
    private static final JobRunnerKey USAGE_AGGREGATION_JOB_KEY =
            JobRunnerKey.of("com.koreacb.confluence.ai-page-generation:usageAggregationJobRunner");
